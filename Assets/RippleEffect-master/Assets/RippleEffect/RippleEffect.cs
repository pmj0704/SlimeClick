...
public class RippleEffect : MonoSingleton<RippleEffect>
{
    public AnimationCurve waveform = new AnimationCurve(
        ...
        new Keyframe(0.10f, 0.10f, 0, 0),
        new Keyframe(0.15f, 0.80f, 0, 0),
        new Keyframe(0.20f, 0.30f, 0, 0),
        new Keyframe(0.30f, 0.60f, 0, 0),
        new Keyframe(0.40f, 0.40f, 0, 0),
        new Keyframe(0.50f, 0.55f, 0, 0),
        new Keyframe(0.60f, 0.46f, 0, 0),
        new Keyframe(0.70f, 0.52f, 0, 0),
        new Keyframe(0.80f, 0.50f, 0, 0)
    );
    ...
    class Droplet
    {
        ...
        public void Reset()
        {
            position = GameManager.Instance.mousePos;
            Debug.Log("Rp" + position);
            time = 0;
        }
        ...
        public Vector4 MakeShaderParameter(float asepect)
        {
